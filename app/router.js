module.exports = app => {
  ...
  router.get(
    '/address/:address/nrc20-balance/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.nrc20TokenBalance
  )
  router.get(
    '/address/:address/txs',
  ...
  router.get(
    '/address/:address/nrc20-txs/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.nrc20TokenTransactions
  )
  router.get(
    '/address/:address/nrc20-mempool-txs/:token',
    addressMiddleware, middleware.contract('token'),
    controller.address.nrc20TokenMempoolTransactions
  )
  router.get(
  ...
  router.get(
    '/address/:address/nrc20-balance-history',
    addressMiddleware, paginationMiddleware,
    controller.address.nrc20BalanceHistory
  )
  router.get(
    '/address/:address/nrc20-balance-history/:token',
    addressMiddleware, middleware.contract('token'), paginationMiddleware,
    controller.address.nrc20BalanceHistory
  )
  ...
  router.get(
    '/contract/:contract/nrc20-balance-history',
    contractMiddleware, paginationMiddleware,
    controller.contract.nrc20BalanceHistory
  )
  router.get(
    '/contract/:contract/nrc20-balance-history/:token',
  ...
  router.get(
    '/nrc20',
    paginationMiddleware,
    controller.nrc20.list
  )
  router.get(
    '/nrc20/txs',
    paginationMiddleware,
    controller.nrc20.allTransactions
  )
  router.get(
    '/nrc20/:token/txs',
    middleware.contract('token'), paginationMiddleware, blockFilterMiddleware,
    controller.nrc20.transactions
  )
  router.get(
    '/nrc20/:token/rich-list',
    middleware.contract('token'), paginationMiddleware,
    controller.nrc20.richList
  )
  router.get(
    '/nrc721',
    paginationMiddleware,
    controller.nrc721.list
  )
